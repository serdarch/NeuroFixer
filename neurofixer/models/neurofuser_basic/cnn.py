...
class NeuroFuserBasicCNN(nn.Module):
...
def build_neurofuser_basic_cnn(num_classes: int = 19, in_channels: int = 3, latent_dim: int = 128) -> NeuroFuserBasicCNN:
    return NeuroFuserBasicCNN(num_classes=num_classes, in_channels=in_channels, latent_dim=latent_dim)
